        ...
        <section>
            <form action="./home.html" class ="w-25 p-5 rounded mx-auto d-block fs-5 " >
               ...
               <style>
                ...
                <p id="login" class="fs-2 text-center mb-1">LOGIN:</p>
            ...
            <div class="btn-group w-100 mt-4" style="gap: 20px;">
                ...
                <button type="reset" class="btn btn-outline-danger w-50 ">LIMPAR</button>
                    ...
                    <a href="cadastro.html" class="text-decoration-none"><p id="ntenho" class="fs-2 text-center mb-1 mt-5 ">NÃO TENHO CADASTRO</p></a>
            </form>
