        ...
        <main>
            ...
            <section>
                <form action="{{ route('usuario-store') }}" method="POST">
                    ...
                    <input required type="text" name="cpf" class=" cpf w-100 text-center" placeholder="000.000.000-00">

                    <label class="fs-2 d-flex flex-column mb-1">Senha*</label>
                    <input required type="password" name="password" class="w-100 text-center" placeholder="Senha">
                    ...
                    <a href="login" class="text-decoration-none">
                        <p id="ntenho" class="fs-2 text-center mb-1 mt-5 ">VOLTAR</p>
                    </a>
                </form>
